exp_name = 'me_non_blind_2fold_8layers'
...
data = dict(
    train=dict(
        data_items='./data/non_blind_2_fold_tr_items.npy',
        name='MultiEdgeGraphGenesV5_2fold_tr',
        include_omic=['expr', 'mut', 'cn']
    ),
    val=dict(
        data_items='./data/non_blind_2_fold_val_items.npy',
        name='MultiEdgeGraphGenesV5_2fold_val',
        include_omic=['expr', 'mut', 'cn']
    ),
)
