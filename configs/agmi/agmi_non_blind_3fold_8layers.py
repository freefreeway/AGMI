exp_name = 'me_non_blind_3fold_8layers'
...
data = dict(
    train=dict(
        data_items='./data/non_blind_3_fold_tr_items.npy',
        name='MultiEdgeGraphGenesV5_3fold_tr',
        include_omic=['expr', 'mut', 'cn']
    ),
    val=dict(
        data_items='./data/non_blind_3_fold_val_items.npy',
        name='MultiEdgeGraphGenesV5_3fold_val',
        include_omic=['expr', 'mut', 'cn']
    ),
)
