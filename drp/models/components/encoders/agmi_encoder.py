...
class AGMIEncoder(EdgeGatedGraphEncoder):
    def __init__(self,
        ...
        self.muti_edges_rnn = torch.nn.GRUCell(out_channels, out_channels, bias=bias)
    ...
    def forward(self, x, edge_index=None, edge_weight=None):
        ...
        for i in range(self.num_layers):
            ...
            hidden_m = self.muti_edges_rnn(edge_m, m)
            ...
            for idx, w in enumerate(self.cell_edge_attr[1:]):
                if self.allow_edges[idx + 1] in self.include_edges:
                    ...
                    hidden_m = self.muti_edges_rnn(edge_m, hidden_m)
